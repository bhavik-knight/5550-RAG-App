...
class Config:
    ...
    REFUSAL_OFF_TOPIC = (
        "I am only authorized to answer questions about Nova Scotia driving rules."
    )
    REFUSAL_TOO_LONG = "Your query is too long. Please shorten it and try again."
    REFUSAL_INJECTION = (
        "Your request was blocked due to a potential security violation."
    )
    ...
    JAILBREAK_KEYWORDS = ["dan", "jailbreak", "unfiltered", "do anything now"]
